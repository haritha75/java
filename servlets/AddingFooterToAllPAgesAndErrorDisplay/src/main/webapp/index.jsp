<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"  errorPage="myerrorpage.jsp" %>
<%-- here we are using errorpage whenver getting error we are pointing to the another page then that page display some image in place of error page content --%>
<!DOCTYPE html>
<html>
<head>
