...
public class RockPaperSecissors {
        ...
        while (true) {
            ...
            if (userInput.equals("!exit")) {
                ...
                if (userInput.equals(computerChoice)) {
                    ...
                    playerScore += 50; // Add 50 points for a draw
                } 
                    ...
                    playerScore += 100; // Add 100 points for a win
                } 
                else {
    ...
    private static int readPlayerScore(String playerName) {
        ...
        return 0; // If player name not found, return 0 as the initial score
    }
