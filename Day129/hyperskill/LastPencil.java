...
class LastPencil {
        ...
        while(pencils>0) {
            ...
            if (name.equals("Jack")) {
                ...
                if(pencils==1) {
                    ...
                    int removePencils = isValidRemovedPencils(pencils);
    ...
    private static int isValidPencils() {
        int pencils;
    ...
    private static int isValidRemovedPencils(int pencil) {
        ...
        while (true) {
            ...
            try {
                ...
                pickPencils = sc.nextInt();

                if (pickPencils == 1 || pickPencils == 2 || pickPencils == 3) {

                    if(pickPencils > pencil){
